...
builder.Services.AddDbContext<articleContext>(options => options.UseMySql(s, ServerVersion.AutoDetect(s)));
builder.Services.AddDbContext<familyContext>(options => options.UseMySql(s, ServerVersion.AutoDetect(s)));
builder.Services.AddDbContext<shoppingContext>(options => options.UseMySql(s, ServerVersion.AutoDetect(s)));
